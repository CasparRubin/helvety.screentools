...
- **GitHub:** This repository is [CasparRubin/helvety.screenshots](https://github.com/CasparRubin/helvety.screenshots). The solution and project use the `helvety.screentools` name on disk (assembly / namespace).
